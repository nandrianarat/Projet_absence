        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-chart-bar-33"></i><span class="nav-text">Année Scolaire</span></a>
                        <ul aria-expanded="false">
                            <li><a href="/annee_scolaire">Liste</a></li>
                            <li><a href="/go_annee">Ajouter AS</a></li>

                        </ul>
                    </li>
                    <li class="nav-label">Classes et Sections</li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-world-2"></i><span class="nav-text">Classe</span></a>
                        <ul aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-plug"></i><span class="nav-text">Section</span></a>
                        <ul aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-form"></i><span class="nav-text">Gérer</span></a>
                        <ul aria-expanded="false">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Seconde</div>
                                    <div class="stat-digit"> <i class="fa fa-usd"></i>900</div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Première</div>
                                    <div class="stat-digit"> <i class="fa fa-usd"></i>700</div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Terminale</div>
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Diagramme de Taux de Fréquentation Mensuel</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="m-t-10">
                                    <h4 class="card-title">Taux d'Absence et de Présence</h4>
                                    <h2 class="mt-3">2250</h2>
                                </div>
                                <div class="widget-card-circle mt-5 mb-5" id="info-circle-card">
                                    <i class="ti-control-shuffle pa"></i>
                                </div>
                                <ul class="widget-line-list m-b-15">
                                    <li class="border-right">75% <br><span class="text-success"><i
                                                class="ti-hand-point-up"></i> Présents</span></li>
                                    <li>25% <br><span class="text-danger"><i
                                                class="ti-hand-point-down"></i>Absents</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
